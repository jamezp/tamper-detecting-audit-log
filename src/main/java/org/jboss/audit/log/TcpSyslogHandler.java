 ...
 */
class TcpSyslogHandler extends ExtHandler {
     ...
     */
    TcpSyslogHandler(final InetAddress serverAddress, final int port, final Facility facility, final SyslogType syslogType, final String hostname) throws IOException {
        this.serverAddress = serverAddress;
        this.port = port;
        this.facility = facility;
        this.socket = SocketFactory.getDefault().createSocket(serverAddress, port);
    ...
    public final void doPublish(final ExtLogRecord record) {
        ...
        synchronized (outputLock) {
            ...
            try {
                ...
                try {
                    socketOut.write(bytes, 0, bytes.length);
                    socketOut.write('\n');
                } finally {
                    socketOut.flush();
                }
